...
A full-stack learning hub for organizing technical topics, tools, progress, and future AI-assisted learning in one application.
...
- Docker Compose
- GitHub Actions
- Free hosting plus a separate AWS practice deployment
...
Architecture and planning foundation in progress. Application scaffolding has not started.
